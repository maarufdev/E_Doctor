...
public static class DependencyInjection
{
    ...
    private static IServiceCollection AddMSSQL(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var conString = $"Server={mssqlConfig.DataSource};Database={mssqlConfig.Database};Trusted_Connection=True;TrustServerCertificate=True;MultipleActiveResultSets=True;Connect Timeout=60;Max Pool Size=200; Min Pool Size=10;";
