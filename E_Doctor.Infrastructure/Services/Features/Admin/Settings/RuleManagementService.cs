...
{
    internal class RuleManagementService(
        ...
        ) : IRuleManagementService
    {
        ...
        public async Task<bool> DeleteIllnessById(int id)
        {
            ...
            await _activityLogger.LogAsync(
                userId,
                UserActivityTypes.RemoveIllness,
                illness.IllnessName
                );
        ...
        public async Task<Result> SaveIllness(IllnessDTO requestDto)
        {
            try
            {
                ...
                string activityDescriptions = string.Empty;
                ...
                if (illnessId == 0)
                {
                    ...
                    activityTypes = UserActivityTypes.CreateIllness;
                    activityDescriptions = illnessEntity.IllnessName;
                }
                else
                {
                    ...
                    activityTypes = UserActivityTypes.UpdateIllness;
                    activityDescriptions = illness.IllnessName;
                }
