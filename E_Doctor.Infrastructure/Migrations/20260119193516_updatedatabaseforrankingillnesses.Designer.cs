...
namespace E_Doctor.Infrastructure.Migrations
{
    ...
    [Migration("20260119193516_updatedatabaseforrankingillnesses")]
    partial class updatedatabaseforrankingillnesses
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("E_Doctor.Core.Domain.Entities.Admin.DiagnosisIllnessesEntity", b =>
                {
                    ...
                    b.Property<int>("ExpectedRulesCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MatchedRulesCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Doctor.Core.Domain.Entities.Patient.PhysicalExam.PhysicalExamItemsEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2026, 1, 19, 19, 35, 16, 438, DateTimeKind.Utc).AddTicks(8926),
                            InputType = "",
                            IsActive = false,
                            Label = "General",
                            SortOrder = 1
